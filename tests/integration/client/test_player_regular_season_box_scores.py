...
class TestWestbrook2020(TestCase):
    ...
    def test_length(self, m):
        m.get("https://www.basketball-reference.com/players/w/westbru01/gamelog/2020", text=self._html, status_code=200)
...
class TestWestbrook2019(TestCase):
    ...
    @requests_mock.Mocker()
    def test_length(self, m):
        m.get("https://www.basketball-reference.com/players/w/westbru01/gamelog/2019", text=self._html, status_code=200)
...
class TestNonExistentPlayerPlayoffBoxScores(TestCase):
    ...
    def test_non_existent_player_raises(self, m):
        ...
        m.get("https://www.basketball-reference.com/players/f/foobar/gamelog/2020", text=self._html, status_code=200)
...
class TestJabariBrown2015(TestCase):
    ...
    def test_default_does_not_include_inactive_games(self, m):
        m.get("https://www.basketball-reference.com/players/b/brownja01/gamelog/2015", text=self._html, status_code=200)
    ...
    def test_does_not_include_inactive_games_when_explicitly_specified(self, m):
        ...
        results = regular_season_player_box_scores(
            player_identifier="brownja01", season_end_year=2015, include_inactive_games=False
        )
        self.assertEqual(19, len(results))
        self.assertEqual(datetime.strptime("2015-03-12", "%Y-%m-%d").date(), results[0]["date"])
    ...
    def test_include_inactive_games_when_explicitly_specified(self, m):
        ...
        results = regular_season_player_box_scores(
            player_identifier="brownja01", season_end_year=2015, include_inactive_games=True
        )
...
class TestAveryBradley2019(TestCase):
    ...
    def test_in_memory_json_output(self, m):
        m.get("https://www.basketball-reference.com/players/b/bradlav01/gamelog/2019", text=self._html, status_code=200)
        ...
        with open(self.expected_excluding_inactive_games_output_json_file_path, encoding="utf8") as expected_output:
            self.assertEqual(
                json.loads(results),
    ...
    def test_json_file_output_excluding_inactive_games(self, m):
        ...
        try:
            ...
            with (
                open(output_file_path, encoding="utf8") as output_file,
                open(self.expected_excluding_inactive_games_output_json_file_path, encoding="utf8") as expected_file,
            ):
    ...
    def test_json_output_including_inactive_games(self, m):
        ...
        with open(self.expected_including_inactive_games_output_json_file_path, encoding="utf8") as expected_output:
            self.assertEqual(
                json.loads(results),
                json.load(expected_output),
            )
    ...
    def test_csv_file_output_excluding_inactive_games(self, m):
        ...
        try:
            ...
            with (
                open(output_file_path, encoding="utf8") as output_file,
                open(self.expected_excluding_inactive_games_output_csv_file_path, encoding="utf8") as expected_file,
            ):
                output_lines = output_file.readlines()
                expected_lines = expected_file.readlines()
    ...
    def test_csv_file_output_including_inactive_games(self, m):
        ...
        try:
            ...
            with (
                open(output_file_path, encoding="utf8") as output_file,
                open(self.expected_including_inactive_games_output_csv_file_path, encoding="utf8") as expected_file,
            ):
                output_lines = output_file.readlines()
                expected_lines = expected_file.readlines()
