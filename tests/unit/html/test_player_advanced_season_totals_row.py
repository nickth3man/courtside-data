...
from courtside_data.legacy.html import PlayerAdvancedSeasonTotalsRow
...
class TestPlayerAdvancedSeasonTotalsRow(TestCase):
    ...
    @patch.object(
        PlayerAdvancedSeasonTotalsRow, "team_abbreviation", new_callable=PropertyMock, return_value="Not Total"
    )
    ...
    @patch.object(PlayerAdvancedSeasonTotalsRow, "team_abbreviation", new_callable=PropertyMock, return_value="2TM")
