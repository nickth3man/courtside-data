...
class FranchiseHistoryRow(BRRow):
    ...
    rank_team: BRIntOrNone = Field(default=None, validation_alias="rank_team")
    srs: BRFloatOrNone = Field(default=None, validation_alias="srs")
    pace: BRFloatOrNone = Field(default=None, validation_alias="pace")
    ...
    rank_team_playoffs: BRIntOrNone = Field(default=None, validation_alias="rank_team_playoffs")
