...
class Team(Enum):
    ...
    DENVER_NUGGETS_1949 = "DENVER NUGGETS (1949-50)"
    ...
    DENVER_ROCKETS = "DENVER ROCKETS"
    INDIANA_PACERS_ABA = "INDIANA PACERS (ABA)"
    KENTUCKY_COLONELS = "KENTUCKY COLONELS"
    MEMPHIS_SOUNDS = "MEMPHIS SOUNDS"
    MEMPHIS_TAMS = "MEMPHIS TAMS"
    NEW_ORLEANS_BUCCANEERS = "NEW ORLEANS BUCCANEERS"
    NEW_YORK_NETS_ABA = "NEW YORK NETS (ABA)"
    OAKLAND_OAKS = "OAKLAND OAKS"
    PITTSBURGH_CONDORS = "PITTSBURGH CONDORS"
    SAN_ANTONIO_SPURS_ABA = "SAN ANTONIO SPURS (ABA)"
    SAN_DIEGO_CONQUISTADORS = "SAN DIEGO CONQUISTADORS"
    SAN_DIEGO_SAILS = "SAN DIEGO SAILS"
    SPIRITS_OF_ST_LOUIS = "SPIRITS OF ST. LOUIS"
    UTAH_STARS = "UTAH STARS"
